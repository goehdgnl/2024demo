...
public:
    PathSelector() {
        ...
        emg_sub = nh.subscribe("/emg_msg", 10, &PathSelector::stopMsgCallback, this); // 긴급정지
    ...
    void stopMsgCallback(const std_msgs::Int32::ConstPtr& msg) {
    emg_stop = msg->data;
}
    void stop_robot() {
    ...
    void choose_best_path() {
        ...
        double angular_velocity_ratios[7] = {0.7,0.47,0.24,0,-0.24,-0.47,-0.7};
